...
import { ModaisFormulariosNovoCartaoComponent } from './novo-cartao.component';
...
@NgModule({
    declarations: [ModaisFormulariosNovoCartaoComponent],
    ...
    exports: [ModaisFormulariosNovoCartaoComponent]
})
export class ModaisFormulariosNovoCartaoModule {}
