...
import { MovimentacoesCardMovimentacaoContabilComponent } from './card-movimentacao-contabil.component';
...
@NgModule({
    declarations: [MovimentacoesCardMovimentacaoContabilComponent],
    ...
    exports: [MovimentacoesCardMovimentacaoContabilComponent]
})
export class MovimentacoesCardMovimentacaoContabilModule {}
