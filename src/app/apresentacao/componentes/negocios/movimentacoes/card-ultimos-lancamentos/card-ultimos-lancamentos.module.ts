...
import { MovimentacoesCardUltimosLancamentosComponent } from './card-ultimos-lancamentos.component';
...
@NgModule({
    declarations: [MovimentacoesCardUltimosLancamentosComponent],
    ...
    exports: [MovimentacoesCardUltimosLancamentosComponent]
})
export class MovimentacoesCardUltimosLancamentosModule {}
